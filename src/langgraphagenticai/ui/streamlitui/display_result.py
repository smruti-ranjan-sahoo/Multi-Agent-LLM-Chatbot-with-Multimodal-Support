...
#     - Advanced Chatbot (uses full history)
#     - Multi-Agent Chatbot (latest user msg only, plus image if present)
#     - Document QA (latest user msg + query)
#     """
...
#         # Append assistant message to UI transcript
